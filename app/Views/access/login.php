...
<head>
    ...
    <script>
         ...
         document.addEventListener( "DOMContentLoaded", function () { 
          ...
          document.getElementById('copy').innerHTML = `CickFinans &copy; ${year} - Rodrigo Guimarães`;
...
<body class="text-center">
    ...
    <main class="form-signin"> 
        ...
        <?= csrf_field() ?>
            <img class="mb-4" src="<?php echo base_url('public/images/icons/dollar1.png') ?>" alt="" width="98" height="98">
